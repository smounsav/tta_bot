...
class DELTA(nn.Module):
    ...
    def reset(self):
        ...
        if self.args.optim_type=='adam':
            ...
            self.optimizer = torch.optim.SGD(params, lr=self.args.lr, momentum=self.args.optim_momentum, weight_decay=self.args.optim_wd)
        ...
        with torch.enable_grad():
            ...
            if self.args.loss_type=='entropy':
                ...
                if self.args.ent_w:
                    ...
                    use_idx = (entropys < math.log(self.args.class_num) * 0.6)                    
            ...
            margin = math.log(10)*0.70
            use_idx = (entropys < margin) 
